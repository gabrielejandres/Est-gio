...
<?php	
		...
		if(isset($_POST['mensagem'])){
			...
			$sql = mysqli_query($conexao,"INSERT INTO mensagens(remetente, destinatario, mensagem, data, grupo) VALUES($id_remetente, 0 , '$mensagem', '$date', $idgp)") or die("Erro ao tentar enviar mensagem");
			$_SESSION['idgp'] = $idgp;
			header("Location: mensagemgp.php"); //redireciona para os dados não serem duplicados
			//echo $mensagem;
		}
...
?>
		<div class="chat">
			<div class="destinatario">
				<?php
					$select_nome = mysqli_query($conexao,"SELECT * FROM grupos WHERE id = '$idgp' ") or die("Erro ao procurar nome");
			...
			<div class="mensagens">
				<?php
					$select_msgs = mysqli_query($conexao,"SELECT * FROM mensagens WHERE grupo = '$idgp' order by data ") or die("Erro ao procurar mensagens");
